...
let CpfService = class CpfService {
    constructor(cpfRepository) {
        this.cpfRepository = cpfRepository;
    }
    async create(data) {
        const cpf = this.cpfRepository.create(data);
        return this.cpfRepository.save(cpf);
    }
    async findByResponsible(responsavel) {
        return this.cpfRepository.find({
            where: [
                { filiacao: { pai: responsavel } },
                { filiacao: { mae: responsavel } },
                { filiacao: { responsavel_legal: responsavel } },
            ],
        });
    }
};
...
exports.CpfService = CpfService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(cpf_entity_1.Cpf)),
