...
let CpfController = class CpfController {
    ...
    createCpf(createCpfDto) {
        return this.cpfService.create(createCpfDto);
    }
    searchCpf(responsavel) {
        return this.cpfService.findByResponsible(responsavel);
    }
};
...
], CpfController.prototype, "createCpf", null);
__decorate([
    (0, common_1.Get)('search'),
    __param(0, (0, common_1.Query)('responsavel')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CpfController.prototype, "searchCpf", null);
exports.CpfController = CpfController = __decorate([
    (0, common_1.Controller)('cpf'),
